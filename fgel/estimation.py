...
def fgel_estimation(
    ...
    if version == "kernel":
        ...
        raise NotImplementedError(
            "Invalid version specified. Use either `kernel` or `neural`."
        )
